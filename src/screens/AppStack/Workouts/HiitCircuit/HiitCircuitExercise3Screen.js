...
export default class HiitCircuitExercise3Screen extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleFinish = async (exerciseList, fitnessLevel) => {
    ...
    this.props.navigation.replace('HiitCircuitRest3', {
      exerciseList,
      fitnessLevel,
      setCount,
    });
        ...
        >
          <View>
            <Video
              ...
              source={{ uri: `${FileSystem.cacheDirectory}exercise-hiit-circuit-3.mp4` || exerciseList[2].videoURL }}
              isMuted
              resizeMode="contain"
              repeat
              paused={videoPaused}
