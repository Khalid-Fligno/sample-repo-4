...
export default class HiitCircuitExercise4Screen extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      exerciseList: props.navigation.getParam('exerciseList', null),
      currentExercise: props.navigation.getParam('exerciseList', null)[3],
  ...
  handleFinish = async (exerciseList, fitnessLevel) => {
    ...
    this.props.navigation.replace('HiitCircuitRest4', {
      exerciseList,
      fitnessLevel,
      setCount,
    });
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'OK',
          onPress: () => {
            this.props.navigation.replace('HiitCircuitExercise4', {
              exerciseList,
              fitnessLevel,
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Skip',
          onPress: () => {
            this.props.navigation.replace('HiitCircuitExercise5', {
              exerciseList,
              fitnessLevel,
              setCount: this.props.navigation.getParam('setCount', 1),
            });
        ...
        >
          <View>
            <Video
              ...
              source={{ uri: `${FileSystem.cacheDirectory}exercise-hiit-circuit-4.mp4` || exerciseList[3].videoURL }}
              isMuted
              resizeMode="contain"
              repeat
              paused={videoPaused}
