...
export default class HiitCircuitExercise5Screen extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleFinish = async (exerciseList, fitnessLevel) => {
    ...
    this.props.navigation.replace('HiitCircuitRest5', {
      exerciseList,
      fitnessLevel,
      setCount,
    });
        ...
        >
          <View>
            <Video
              ...
              source={{ uri: `${FileSystem.cacheDirectory}exercise-hiit-circuit-5.mp4` || exerciseList[4].videoURL }}
              isMuted
              resizeMode="contain"
              repeat
              paused={videoPaused}
